...
These models were estimated with `r R.version.string` running on Windows 10 x64 (build 19043) with an Intel Core i5-6200U CPU (2.30GHz) and 8Gb of DDR3 memory (1867 MHz).
