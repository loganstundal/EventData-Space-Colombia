...
The R-scripts stored in the `Scripts/` directory generate outputs to produce all figures or tables presented in the main article or appendix. These exports are sored in one of three sub-directories in the `Results/` folder:
  ...
  - **`Replication-Figures/`** ~ contains png files for all figure exports
  - **`Published-Models/`** ~ contain compressed Rdata files with pre-estimated models from executing code in `2-models-spde.R` or `3-models-spem.R` 
...
| Script Name  | **4-figures_coefplots.R** |
| :----------- | :----------- |
